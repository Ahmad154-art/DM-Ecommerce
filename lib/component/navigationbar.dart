      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
              icon: InkWell(
                child: selectindex==1?
                    SvgPicture.asset('icons/Buy-fill.svg', color: Color(0xffEB671B)):
                    SvgPicture.asset('icons/Buy.svg', color: Color(0xffEB671B))
              ),
              label: 'Cart'),
          BottomNavigationBarItem(
              icon: InkWell(
          ...
          BottomNavigationBarItem(
            icon: InkWell(
              child: selectindex==3?
                  SvgPicture.asset('icons/Heart-fill.svg', color: Color(0xffEB671B)):
                   SvgPicture.asset('icons/Heart.svg', color: Color(0xffEB671B))
            ),
